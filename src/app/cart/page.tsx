...
const Cart = () => {
  return (
    <div className="mx-auto max-w-[600px] min-h-[40px] relative">
      ...
      <div className="mt-3">
        <div className="listItemSuperCart mb-[100px]">
            ...
            <div className="flex items-start justify-between min-h-[110px] py-2.5">
              ...
              <div className="product-info w-3/4">
                ...
                <div className="flex justify-between mt-[10px]">
                  <div className="price">
                    <p className="text-red-600/100">25.990.000đ</p>
                  </div>
                  <div className="">
                    <span className="bg-[#f3f3f3] rounded-sm cursor-pointer px-3 py-1.5">
                      -
                    </span>
                    <input className="bg-transparent border-0 text-xs text-center w-[30px]"></input>
      ...
      <div className="flex items-center justify-between bg-white border border-[rgba(145,158,171,0.239)] rounded-t-md shadow-[0_-4px_20px_-1px_rgba(40,124,234,0.15)] fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-[600px] p-[10px_10px_15px] z-11">
