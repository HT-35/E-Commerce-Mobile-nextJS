...
const Amnimation = () => {
  ...
  return (
    <div className="relative min-w-[1000px] min-h-screen overflow-hidden w-full h-full flex flex-col bg-transparent">
      ...
      <div className="text-center mt-40 text-4xl select-none">
        Huy Trần FullStack
      </div>
      <div className="text-center mt-8 text-2xl select-none">
        {" "}
        NestJS + NextJS{" "}
      </div>
    </div>
